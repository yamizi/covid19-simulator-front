                ...
                steps: [
                    {
                        ...
                        content: (
                            <React.Fragment>
                                ...
                                in order to assess the impact of different exit
                                strategies. Note that all the measure that this
                                model allow to simulate concerne the
                                modification of mobility (e.g. closing stores,
                                stopping public transportation, etc.) but do not
                                take into action other measure of social
                                distancing such as wearing masks, keeping safety
                                distances, and so on.
                            </React.Fragment>
                        ),
                        disableBeacon: true,
                        ...
                        content: (
                            <React.Fragment>
                                <p>
                                    ...
                                    change the intensitiy. The complete
                                    description of the dataset can be found on
                                    the{" "}
                                    <a
                                ...
                                <ul>
                                    <li>
                                        ...
                                        Mobility trends for places like local
                                        parks, national parks, public beaches,
                                        marinas, dog parks, plazas, and public
                                        gardens.
                                    </li>
                                    <li>
                                        <strong>Public Transport:</strong>{" "}
                                        Mobility trends for places like public
                                        transport hubs such as subway, bus, and
                                        train stations.
                                    </li>
                                    <li>
                                        <strong>Retail & Recreation:</strong>{" "}
                                    ...
                                    <li>
                                        <strong>Workplaces:</strong> Mobility
                    ...
                    },
                    {
                        ...
                        content: (
                            <React.Fragment>
                                "The value represents the activity relative to a
                                baseline which is the median value, for the
                                corresponding day of the week, during the 5-week
                                period starting on January 3, 2020 and ending on
                                Febrary 6, 2020. A value of 100% represent that
                                baseline value; a value lower than 100%
                                represent a decrease of activity (with 0%
                                meaning complete stop of the activity); and a
                                value over 100% represents an increase of the
                    ...
                    },
                    {
                        ...
                        content: (
                            <React.Fragment>
                                ...
                                <ul>
                                    <li>
                                        <strong>Brutal Exit:</strong> All
                                        confinement measures are lifted on the
                                        May 11, 2020.
                                    </li>
                                    <li>
                                        <strong>Cyclic Exit:</strong> All
                    ...
                    },
                    {
                        ...
                        content: (
                            <React.Fragment>
                                ...
                                results are presented in a chart on the right of
                    ...
                    {
                        target: "#covid-country-selection-1",
                        title: "Country Selection",
                        content: (
                            <React.Fragment>
                                Finally, in its current form, the prediction
                                tool only work country by country, making a
                                strong assumption on the fact that all borders
                                are closed. Therefore, the total pool for each
                                simulation is the total population of people
                                leaving in the country at the beginning of the
                                simulation.
                            </React.Fragment>
                        ),
                    },
